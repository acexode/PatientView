                  ...
                  <div class="item carousel-item active">
                    <div class="row">                  
                      <div class="col-md-5 slant">
                        <div class="scontent">
                          <blockquote class="blockquote text-center">
                            ...
                            <footer class="blockquote-footer text-light"> <q class="b"> Nurses may not be angels but they are the next best thing </q></footer>
                      ...
                      <div class="col-md-7 skewLeft">
                        ...
                        <div class="overlay-text pl-2 pr-3  pb-2">
                            <blockquote class="blockquote text-center">
                              <p class="">See what patients are saying about their experience</p>
                            
                              <footer class="blockquote-footer text-light"> <q class="b"> Nurses may not be angels but they are the <br/> next best thing </q></footer>
                              <button type="button" class="btn text-light btn-outline-secondary">See more</button>
                            </blockquote>
